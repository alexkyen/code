...
const aliceTx = alice.generateTx(bob.wallet.address, 5, 'send');
...
const checkAliceAccountBalance = alice.generateTx(alice.wallet.address, 0, 'check');
...
const payBobBackForKetchup = alice.generateTx(bob.wallet.address, 69, 'send');
